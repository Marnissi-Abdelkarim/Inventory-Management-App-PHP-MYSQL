    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Cat&eacute;gorie Produit</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
...
<!------------------------------------------------------------------->
  <?php  $query = 'SELECT * FROM category ORDER by CATEGORY_ID ASC';
                                      ...
                                      ?>
                                       <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#<?php echo $category['CNAME'];?>" data-toggle="tab"><?php echo $category['CNAME']; ?></a>
                              </li>
...
<!------------------------------------------------------------------->
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="#others" data-toggle="tab">Tous les Produits</a>
                              </li>
                            </ul>

<!-- TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
<?php include 'ajtabpan.php'; ?>
<!-- END TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
        ...
        <div class="card-header py-3 bg-white">
          <h4 class="m-2 font-weight-bold text-primary">Ajouter Facture</h4>
        </div>
      ...
      <div class="card-body col-md-9">
        ...
        <!-- trial form lang   -->
<form role="form" method="post" action="aj_transac.php?action=add">
  ...
  <h6><b>Saisir Numero du Facture :</b></h6>
  <input type="text" class="form-control" placeholder="Numero du Facture" name="trid" required>
  </div>
          ...
          <td>
           ...
           <td>
            <input type="hidden" name="id[]" value="<?php echo $product['id']; ?>">
               <a href="AjouterFacture.php?action=delete&id=<?php echo $product['id']; ?>">
